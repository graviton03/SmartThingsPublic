...
preferences {
        ...
        input("gpio_pin", "number", title:"GPIO pin", description: "GPIO pin #", required: false, displayDuringSetup: true)
}

metadata {
	definition (name: "Raspberry Pi", namespace: "graviton03", author: "Nathan Knudson") {
		capability "Polling"
		capability "Refresh"
	...
	tiles {
        ...
        valueTile("contact", "device.contact", width: 1, height: 1) {
...
//    def gpio_value = "gpio_value_${gpio_pin.toString()}"
//    log.debug "${gpio_value}"
